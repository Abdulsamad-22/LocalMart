      ...
      <div className="w-full md:w-[65%] bg-[#fff] rounded-[10px] p-4 flex flex-col md:flex-row gap-4 items-start md:items-end">
        ...
        <div className="w-full md:w-[40%] space-y-4">
          <div className="space-y-2">
            <h2 className="text-[1.25rem] md:text-[1.5rem]">{product.name}</h2>

            <div className="flex items-center">
              <img src={product.ratings.image} alt="" />
              <div className="text-[1rem] md:text-[1.25rem] font-semibold">
            ...
            <div className="text-[0.875rem] md:text-[1rem]">10 Units Left</div>

            <div className="flex items-center justify-between">
              <p className="font-semibold text-[1rem] md:text-[1.25rem]">
                ${product.price}
              </p>
          ...
          <div className="flex items-center w-20 px-0 py-1 gap-2 text-center rounded-md">
            <div
              ...
              className="p-2 transition-transform duration-300 hover:bg-[#009688] hover:border-transparent border-[1px] border-[#c4c4c4] rounded-full cursor-pointer"
            >
              <Minus
                size={20}
            ...
            <div
              ...
              className="transition-transform duration-300 hover:bg-[#009688] border-[1px] border-[#c4c4c4] p-2 rounded-full cursor-pointer"
            >
